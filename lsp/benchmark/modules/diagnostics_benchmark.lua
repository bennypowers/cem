...
function M.run_diagnostics_benchmark(config, fixture_dir)
  ...
  -- Create test HTML file with potential issues
  local html_content = [[<!DOCTYPE html>
<html>
<head><title>Diagnostics Test</title></head>
<body>
  <my-button typo="invalid" unknownattr="test">Click me</my-button>
  <unknown-element></unknown-element>
  <my-card slot="wrongslot">
