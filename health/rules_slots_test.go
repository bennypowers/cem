...
func TestSlotDocRule(t *testing.T) {
	rule := &SlotDocRule{}

	t.Run("full score with no slots", func(t *testing.T) {
	...
	t.Run("full score with well-documented slots", func(t *testing.T) {
