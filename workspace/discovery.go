...
// FindPackageForFile determines which workspace package(s) contain a given file path.
// Returns a list of PackageInfo for packages that contain the file.
// For most files, this will return 0 or 1 package, but shared files could
// potentially affect multiple packages.
func FindPackageForFile(rootDir string, filePath string) ([]PackageInfo, error) {
	...
	var affectedPackages []PackageInfo
