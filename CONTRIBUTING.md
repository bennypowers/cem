...
The monorepo uses **TypeScript ^5.0.0** across all workspace packages for consistency. This is required because:
...
- All new workspace packages should use TypeScript ^5.0.0 in their `devDependencies`
