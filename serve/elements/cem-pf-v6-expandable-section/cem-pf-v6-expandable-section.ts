...
import styles from './cem-pf-v6-expandable-section.css' with { type: 'css' };
 ...
 */
@customElement('cem-pf-v6-expandable-section')
...
declare global {
  interface HTMLElementTagNameMap {
    'cem-pf-v6-expandable-section': PfV6ExpandableSection;
  }
}
