...
import styles from './cem-pf-v6-navigation.css' with { type: 'css' };
 ...
 */
@customElement('cem-pf-v6-navigation')
export class PfV6Navigation extends LitElement {
  ...
  #onSlotChange(e: Event) {
    ...
    this.#navList = elements.find(el => el.tagName === 'CEM-PF-V6-NAV-LIST');
...
declare global {
  interface HTMLElementTagNameMap {
    'cem-pf-v6-navigation': PfV6Navigation;
  }
}
