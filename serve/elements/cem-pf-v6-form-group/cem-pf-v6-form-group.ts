...
import styles from './cem-pf-v6-form-group.css' with { type: 'css' };
 ...
 *
 * @slot label - Label content (typically cem-pf-v6-form-label)
 * @slot - Default slot for form control element
 * @slot helper - Helper text
 */
@customElement('cem-pf-v6-form-group')
...
declare global {
  interface HTMLElementTagNameMap {
    'cem-pf-v6-form-group': PfV6FormGroup;
  }
}
