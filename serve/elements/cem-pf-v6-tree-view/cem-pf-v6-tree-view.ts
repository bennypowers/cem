...
import styles from './cem-pf-v6-tree-view.css' with { type: 'css' };

/**
 * PatternFly v6 Tree View
 *
 * Container for cem-pf-v6-tree-item elements. Coordinates selection and keyboard navigation.
 *
 * @slot - Tree items (cem-pf-v6-tree-item elements)
 */
@customElement('cem-pf-v6-tree-view')
export class PfV6TreeView extends LitElement {
  ...
  expandAll() {
    this.querySelectorAll('cem-pf-v6-tree-item').forEach(item =>
...
/** Interface for cem-pf-v6-tree-item methods used by tree-view */
...
declare global {
  interface HTMLElementTagNameMap {
    'cem-pf-v6-tree-view': PfV6TreeView;
  }
}
