...
import styles from './cem-pf-v6-alert-group.css' with { type: 'css' };
 ...
 *
 * @slot - Default slot for cem-pf-v6-alert elements
 */
@customElement('cem-pf-v6-alert-group')
...
declare global {
  interface HTMLElementTagNameMap {
    'cem-pf-v6-alert-group': PfAlertGroup;
  }
}
