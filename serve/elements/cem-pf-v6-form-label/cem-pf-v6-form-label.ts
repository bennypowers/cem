...
import styles from './cem-pf-v6-form-label.css' with { type: 'css' };

/**
 * PatternFly v6 Form Label Component
 *
 * Automatically associates with control in parent cem-pf-v6-form-group by:
 * - Setting aria-label on the control from label text content
 * - Forwarding clicks to focus the control
 *
 * @slot - Label text content
 */
@customElement('cem-pf-v6-form-label')
...
declare global {
  interface HTMLElementTagNameMap {
    'cem-pf-v6-form-label': PfV6FormLabel;
  }
}
