...
import styles from './cem-pf-v6-tabs.css' with { type: 'css' };
 ...
 * PatternFly v6 Tabs
 *
 * A tabbed content container. Add `cem-pf-v6-tab` children with `title` attributes
 * to define tabs and their panel content.
 *
 * @slot - Default slot for `cem-pf-v6-tab` children
 *
...
export class PfV6Tabs extends LitElement {
  ...
  connectedCallback() {
    ...
    this.addEventListener('cem-pf-v6-tab-title-changed', this.#onTabsChanged);
    this.addEventListener('cem-pf-v6-tab-connected', this.#onTabsChanged);
    this.addEventListener('cem-pf-v6-tab-disconnected', this.#onTabsChanged);
  ...
  disconnectedCallback() {
    ...
    this.removeEventListener('cem-pf-v6-tab-title-changed', this.#onTabsChanged);
    this.removeEventListener('cem-pf-v6-tab-connected', this.#onTabsChanged);
    this.removeEventListener('cem-pf-v6-tab-disconnected', this.#onTabsChanged);
  }
