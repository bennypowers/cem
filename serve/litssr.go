...
// SSR source embedded in the binary. The bundle is produced at
// go generate time by generate_elements.go using the same esbuild
// plugins that lit-ssr-wasm provides.
