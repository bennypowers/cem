...
var y = class extends HTMLElement {
  ...
  static createProperty(t2, s2 = b) {
    if (s2.state && (s2.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(t2) && ((s2 = Object.create(s2)).wrapped = !0), this.elementProperties.set(t2, s2), !s2.noAccessor) {
      let i3 = Symbol(), h2 = this.getPropertyDescriptor(t2, i3, s2);
      h2 !== void 0 && e2(this.prototype, t2, h2);
    }
  }
  static getPropertyDescriptor(t2, s2, i3) {
    let { get: e3, set: r4 } = h(this.prototype, t2) ?? { get() {
      return this[s2];
    }, set(t3) {
      this[s2] = t3;
    } };
    return { get: e3, set(s3) {
      let h2 = e3?.call(this);
      r4?.call(this, s3), this.requestUpdate(t2, h2, i3);
  ...
  _$AK(t2, s2) {
    ...
    if (e3 !== void 0 && this._$Em !== e3) {
      ...
      this._$Em = e3;
      let r4 = h2.fromAttribute(s2, t3.type);
  ...
  C(t2, s2, { useDefault: i3, reflect: e3, wrapped: h2 }, r4) {
    i3 && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(t2) && (this._$Ej.set(t2, r4 ?? s2 ?? this[t2]), h2 !== !0 || r4 !== void 0) || (this._$AL.has(t2) || (this.hasUpdated || i3 || (s2 = void 0), this._$AL.set(t2, s2)), e3 === !0 && this._$Em !== t2 && (this._$Eq ??= /* @__PURE__ */ new Set()).add(t2));
  }
  async _$EP() {
...
var o3 = { attribute: !0, type: String, converter: u, reflect: !1, hasChanged: f }, r3 = (t2 = o3, e3, r4) => {
  let { kind: n4, metadata: i3 } = r4, s2 = globalThis.litPropertyMetadata.get(i3);
  if (s2 === void 0 && globalThis.litPropertyMetadata.set(i3, s2 = /* @__PURE__ */ new Map()), n4 === "setter" && ((t2 = Object.create(t2)).wrapped = !0), s2.set(r4.name, t2), n4 === "accessor") {
    let { name: o4 } = r4;
    return { set(r5) {
      let n5 = e3.get.call(this);
      e3.set.call(this, r5), this.requestUpdate(o4, n5, t2);
    }, init(e4) {
  ...
  if (n4 === "setter") {
    ...
    return function(r5) {
      let n5 = this[o4];
      e3.call(this, r5), this.requestUpdate(o4, n5, t2);
    };
  }
...
function n3(t2) {
  return (e3, o4) => typeof o4 == "object" ? r3(t2, e3, o4) : ((t3, e4, o5) => {
    let r4 = e4.hasOwnProperty(o5);
    return e4.constructor.createProperty(o5, t3), r4 ? Object.getOwnPropertyDescriptor(e4, o5) : void 0;
  })(t2, e3, o4);
}
export {
  n3 as property,
  r3 as standardProperty
};
