...
var y = class extends HTMLElement {
  ...
  static createProperty(t3, s4 = b) {
    if (s4.state && (s4.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(t3) && ((s4 = Object.create(s4)).wrapped = !0), this.elementProperties.set(t3, s4), !s4.noAccessor) {
      let i5 = /* @__PURE__ */ Symbol(), h3 = this.getPropertyDescriptor(t3, i5, s4);
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), p2 = /'/g, g = /"/g, $ = /^(?:script|style|textarea|title)$/i, y2 = (t3) => (i5, ...s4) => ({ _$litType$: t3, strings: i5, values: s4 }), x = y2(1), b2 = y2(2), w = y2(3), T = /* @__PURE__ */ Symbol.for("lit-noChange"), E = /* @__PURE__ */ Symbol.for("lit-nothing"), A = /* @__PURE__ */ new WeakMap(), C = r3.createTreeWalker(r3, 129);
function P(t3, i5) {
