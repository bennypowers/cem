...
// TestGlobPatternExpansionFast tests the regression fix for glob pattern expansion
// using in-memory operations for instant testing without disk I/O overhead.
func TestGlobPatternExpansionFast(t *testing.T) {
...
// TestNilManifestHandlingFast tests the regression fix for nil pointer dereference
// using in-memory operations for instant error condition simulation.
func TestNilManifestHandlingFast(t *testing.T) {
...
// TestFileReadErrorFast tests file read error handling with instant setup
func TestFileReadErrorFast(t *testing.T) {
	// Create in-memory filesystem
	mapFS := platform.NewMapFileSystem(nil)
...
// TestErrorConditionsFast tests various error conditions with instant simulation
func TestErrorConditionsFast(t *testing.T) {
	mapFS := platform.NewMapFileSystem(nil)
